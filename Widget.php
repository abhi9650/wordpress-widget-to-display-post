<?php
/*
 * Plugin Name: EditMeet Widget
 * Version: 1.0.0.1
 * Plugin URI: https://editmeet.com/
 * Description: Plugin to display posts from Editmeet.com. 
 * Author: EditMeet
 * Author URI:https://editmeet.com/ 
 * License: GNU
 */
function EditMeet_insert_category() {
	wp_insert_term(
		'EditMeet',
		'category',
		array(
		  'description'	=> 'This is the category created automatically by EditMeet.',
		  'slug' 		=> 'EditMeet'
		)
	);
}

add_action( 'after_setup_theme', 'EditMeet_insert_category' );
...
class PFCWidget extends WP_Widget {
	...
	*/	
	public function __construct() {
		...
		$widget_ops = array(						
						...
						'description' 	=> esc_html__( 'Display press releases from EditMeet.com', 'PFC') 
					);

		parent::__construct('PFCWidget', esc_html__( ' EditMeet', 'PFC' ), $widget_ops, $control_ops);
	...
	*/
	function widget($args, $instance){
		...
		$post_cat 		= ! empty( $instance['post_cat'] ) ? $instance['post_cat'] : get_cat_ID( EditMeet);
